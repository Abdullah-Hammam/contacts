...
namespace ContactsBusinessLayer
{
    public class clsCountry
    {
        ...
        public static bool DeleteCountry(int ID) => clsCountryData.DeleteCountry(ID);


        public static bool isCountryExist(int ID) => clsCountryData.IsCountryExist(ID);


        public static bool isCountryExist(string CountryName) => clsCountryData.IsCountryExist(CountryName);

...
namespace ContactsBusinessLayer
{
    public class clsContact
    {
        ...
        public static DataTable GetAllContacts() => clsContactDataAccess.GetAllContacts();

        public static bool DeleteContact(int ID) => clsContactDataAccess.DeleteContact(ID);

        public static bool isContactExist(int ID) => clsContactDataAccess.IsContactExist(ID);
